...
function renderCommitInfo(data, commits) {
  ...
  // Add files changes
  const numFilesChanged = new Set(data.map((d) => d.file)).size;
  dl.append('dt').text('Files changed');
  dl.append('dd').text(numFilesChanged);
...
function renderScatterPlot(data, commits) {
  ...
  dots
    ...
    .on('mouseleave', () => {
      renderTooltipContent({}); // Clear tooltip content
    });
}
